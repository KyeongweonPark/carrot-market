...
const Create: NextPage = () => {
  return (
    <div className="space-y-5 py-10 px-4">
      ...
      <button className="w-full rounded-md border border-transparent bg-orange-500 py-2 px-4 font-medium text-white shadow-sm hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
        Go live
      </button>
    </div>
  );
